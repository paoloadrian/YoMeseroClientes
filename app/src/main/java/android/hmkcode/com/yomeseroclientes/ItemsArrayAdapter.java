...
public class ItemsArrayAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Button button = (Button) rowView.findViewById(R.id.plusbutton);
    ...
    private class ButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.plusbutton) {
                int quant = Integer.parseInt(textView.getText().toString());
                textView.setText(Integer.toString(quant + 1));
            }
        }
    }
}
